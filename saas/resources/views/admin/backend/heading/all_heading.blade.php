                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tb-col tb-col-md">
                            <div class="fs-6 text-light d-inline-flex flex-wrap gap gx-2">{{ $heading->title }}</div>
                        </td>
                        <td class="tb-col tb-col-sm">
                            <div class="fs-6 text-light">{!! Str::limit($heading->description, 50, '...') !!}</div>
                        </td>
                        <td class="tb-col tb-col-md">
                            <a href="{{ route('edit.heading', $heading->id) }}" class="btn btn-success btn-sm">Edit</a>
                            <a href="{{ route('delete.heading', $heading->id) }}" id="delete" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>

        ...
        <div class="nk-block-head nk-page-head">
            <div class="nk-block-head-between flex-wrap gap g-2">
                <div class="nk-block-head-content">
                    <h2 class="display-6">All Documents</h2>
                </div>
                <div class="nk-block-head-content">
                </div>
            </div>
            ...
            <table class="table table-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tb-col tb-col-md">
                            <a href="{{ route('admin.document.edit', $document->id) }}" class="btn btn-success btn-sm">Edit</a>
                            <a href="{{ route('admin.document.delete', $document->id) }}" id="delete" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>

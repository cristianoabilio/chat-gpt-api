...
<div class="nk-content-body">
    <div class="nk-block-head nk-page-head">
        <div class="nk-block-head-content">
            <h2 class="title display-6">Chat Assistant <strong>{{ $assistant->name }}</strong></h2>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body p-0">
                    <a href="{{ route('chat-assistant.new',['assistantId' => $assistant->id]) }}" class="btn btn-primary w-100 rounded-0"> + New Conversation </a>
            ...
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="card-footer bg-white border-top">
                        <form action="{{ route('chat-assistant.send', ['assistantId' => $assistant->id]) }}" method="post" class="input-group">
                            @csrf

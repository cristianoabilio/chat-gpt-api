...
<body>
    <div class="invoice-box">
        ...
        <div class="details">
            <div>
                <h3>Billed To</h3>
                <p><strong>Name:</strong> {{ $billing->user->name }} </p>
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>  {{ $billing->plan->name }} Plan</td>
                    <td>  {{ $billing->plan->monthly_word_limit }} words</td>
        ...
        <div class="footer">
            ...
            <p><strong>Payment Status:</strong> {{ $billing->status ? : 'N/A'}} </p>

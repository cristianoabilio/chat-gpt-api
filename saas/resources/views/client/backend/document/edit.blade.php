        ...
        <div class="nk-block-head nk-page-head">
            <div class="nk-block-head-between">
                <div class="nk-block-head-content">
                    <h2 class="display-6">Template: </h2>
                </div>
            </div>
        </div><!-- .nk-page-head -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <form action="{{ route('user.update.document', $document->id) }}" method="post" id="editDocumentForm" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" id="editor-output" name="output" >
                            <div class="nk-editor">
                                <div class="nk-editor-header">
                                    <div class="nk-editor-title">
                                        <h4 class="me-3 mb-0 line-clamp-1">
                                            {{ json_decode($document->input, true)['Blog_Titles'] }}
                                        </h4>
                                    </div>
                                    <div class="nk-editor-tools d-none d-xl-flex">
                                        <ul class="d-inline-flex gap gx-3">
                                            <li>
                                                <button type="submit" class="btn btn-md btn-primary rounded-pill">Save</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
